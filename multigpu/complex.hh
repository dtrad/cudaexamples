...
{
  return ((float) sqrt((float) (a.r*a.r+a.i*a.i)));
}
...
inline void multconj(complex& a, complex& b, complex& c)
{
  // multiply conjugate same as conj(a)*b, try one go for speed.
  float ar=a.r,ai=-a.i,br=b.r,bi=b.i; // notice a conj.
  c.r=ar*br-ai*bi;
  c.i=ar*bi+ai*br;
}
